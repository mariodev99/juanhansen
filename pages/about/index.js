  ...
  return (
    ...
    >
      ...
      <div className="">
        ...
        >
          <p className="text-md">
            Juan Hansen is a trailblazer in the electronic music scene, renowned
            for his innovative approach and unwavering dedication to the craft.
            As an Argentinean DJ and producer, he has captivated audiences
            worldwide with his electrifying performances and groundbreaking
            tracks. From his early days spinning records in local clubs to
            headlining major festivals across the globe, Juan has continually
      ...
      <div className="">
        <div className="overflow-hidden">
          <motion.h2
            ...
            initial="hidden"
            animate="visible"
            className="uppercase text-xs md:text-sm mt-5 mb-2 md:mb-4"
          >
            focus
          </motion.h2>
        </div>
